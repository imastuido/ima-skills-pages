...
window.I18N = {
  zh: {
    ...
    skills: {
      ...
      installHint: '推荐使用「复制安装命令」复制 git clone 到本地技能目录安装；或从上方 GitHub 仓库链接下载。使用前请阅读 ima-knowledge-ai。',
    },
    how: {
      title: '使用方式',
  ...
  en: {
    ...
    skills: {
      ...
      installHint: 'Recommended: use "Copy install command" to copy the git clone command into your local skills directory; or download from the GitHub links above. Read ima-knowledge-ai before use.',
    },
    how: {
      title: 'How to Use',
